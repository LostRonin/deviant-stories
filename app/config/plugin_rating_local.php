 ...
 */
$config['Rating.appRoot'] = '/deviant-stories-dev/';
 ...
 */
$config['Rating.starFullImageLocation'] = 'img/star-full.png';

/**
 * Location of the empty star image.
 */
$config['Rating.starEmptyImageLocation'] = 'img/star-empty.png';

/**
 * Location of the half star image.
 */
$config['Rating.starHalfImageLocation'] = 'img/star-half.png';

/**
 * Save the average rating and vote count to the rated model.
 * 
 * This may speed up loading, because the values must not 
 * be calculated from the ratings on every access. This is also 
 * helpful if you want to sort the model by rating data, e.g. using 
 * pagination sort.
 * 
 ...
 */
$config['Rating.showMouseOverMessages'] = false;
